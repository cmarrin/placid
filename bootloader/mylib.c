...
//static int strncmp(char const *str1, char const *str2, int len)
//{
//    char *s1 = (char *) str1;
//    char *s2 = (char *) str2;
//    while(len--) {
...
//static int log(char *str, const char *format, ...)
//{
//    va_list ap;
//    int i;
//    int len;
...
void log_error(int error_id) {
	...
	//io_cli();
    putstr(s);
	putchar('0'+error_id); // error_id must be between 0 and 9;
	while(1) {}
}
